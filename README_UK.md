...
<div align="center">
  <img src="https://img.shields.io/badge/Software%Developer-2a9abd?style=for-the-badge&logo=cplusplus&logoColor=fff" />
...
# Ласкаво просимо до мого GitHub профілю! 👋

Я розробник, захоплений сучасними веб-технологіями та низькорівневим програмуванням.

## 🌟 Про мене

- 💻 Займаюся Front-end розробкою та C++.
- ⚛️ Вивчаю та створюю проєкти з використанням React, TypeScript і сучасного JavaScript.
- 🎨 Люблю створювати адаптивні та зручні користувацькі інтерфейси.
- 🧠 Також маю досвід роботи з низькорівневими концепціями програмування, керуванням пам’яттю та арифметикою вказівників у C++.
...
<!-- Системна розробка -->
<details open>
  <summary>📝 Системна розробка: </summary>
  <br>
...
<!-- Скриптування та автоматизація процесів -->

<details open> 
<summary> 🐍 Скриптування та автоматизація процесів: </summary>
  <br>
  
  [![python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=fff&style=for-the-badge)](https://docs.python.org/3.16/)
  [![Lua Badge](https://img.shields.io/badge/Lua-000080?logo=lua&logoColor=fff&style=for-the-badge)](https://www.lua.org/docs.html)
...
<details open> 
<summary> 🌐 Веб-технології: </summary>
  <br>
  
  [![html](https://github.com/RusProgger/RusProgger/assets/105813644/be45eace-63b7-47a4-8bf9-c7325788e397)](https://developer.mozilla.org/en-US/docs/Web/HTML)
  [![css](https://github.com/RusProgger/RusProgger/assets/105813644/039c2cbc-20dc-4a75-bde4-a74e56f98126)](https://developer.mozilla.org/en-US/docs/Web/CSS)
...
<details open>
  ...
  [![valgrind Badge](https://img.shields.io/badge/valgrind-a89332?logo=valgrind&logoColor=fff&style=for-the-badge)](https://valgrind.org/)
...
|------------|----------------|--------|
|![C++ Badge](https://img.shields.io/badge/C%2B%2B-00599C?logo=cplusplus&logoColor=fff&style=for-the-badge)| StringHelp — це легка header-only бібліотека для роботи з регістром рядків у C++.   | https://github.com/RusProgger/StringHelp |
|![C++ Badge](https://img.shields.io/badge/C%2B%2B-00599C?logo=cplusplus&logoColor=fff&style=for-the-badge)| BinaryLab — це простий консольний інструмент для роботи з двійковим поданням чисел. Проєкт дозволяє користувачеві вводити десяткове число та наочно бачити його двійкове представлення в зручному та структурованому вигляді. Він створений як навчальний інструмент для розуміння того, як числа зберігаються та обробляються на рівні бітів.  | https://github.com/RusProgger/BinaryLab |
|![C++ Badge](https://img.shields.io/badge/C%2B%2B-00599C?logo=cplusplus&logoColor=fff&style=for-the-badge)| Це консольний застосунок на C++, який отримує та відображає базову інформацію про комп’ютер за допомогою WinAPI.  | https://github.com/RusProgger/pcInfoTools |
