...
Я разработчик, увлечённый современными веб-технологиями и низкоуровневым программированием.

## 🌟 Обо мне

- 💻 Занимаюсь Front-end разработкой и C++.
- ⚛️ Изучаю и создаю проекты с использованием React, TypeScript и современного JavaScript.
- 🎨 Люблю создавать адаптивные и удобные пользовательские интерфейсы.
- 🧠 Также имею опыт работы с низкоуровневыми концепциями программирования, управлением памятью и арифметикой указателей в C++.
...
<details open>
  <summary>📝 Системная разработка: </summary>
  <br>
...
<details open> 
<summary> 🌐 Веб технологии: </summary>
  <br>
